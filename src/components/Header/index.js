            ...
            <Container>
                <div className="mx-auto">
                    <div className="flex items-center justify-between p-4">
                        <a href="/">
                            <img style={{maxWidth:"60px"}} src="static/images/logo_uoh.png" alt="prueba"/>
                        </a>
                        <Hidden mdDown>
                            <nav className="hidden md:flex items-center text-black">
                                ...
                                >
                                    <a href="/">
                                        <MenuItem
                                            onClick={handleClose}>Gráficos interactivos
                                        </MenuItem></a>
                                    <a href="/">
                                        <MenuItem

                                            onClick={handleClose}>Gráficos georreferenciados

                                        </MenuItem></a>
                                    <a href="/">
                                        <MenuItem
                                            onClick={handleClose}>Gráficos lineales
                                        </MenuItem></a>
            ...
            >
                ...
                >
                    <List>
                        ...
                        <ListItem>
                            <a href="/">
                                <ListItemText primary="Gráficos"></ListItemText>
                            </a>
                        </ListItem>
                        <ListItem>
                            <a href="/"><ListItemText primary="Testimonios"></ListItemText> </a>
                        </ListItem>
                        <ListItem>
